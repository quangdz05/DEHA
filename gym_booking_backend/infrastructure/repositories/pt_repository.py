...
from gym_booking_backend.application.interfaces import IPTRepository
...
_instance = DjangoPTRepository()
get_active_pt_packages = _instance.get_active_pt_packages
get_pt_package_by_id = _instance.get_pt_package_by_id
get_trainer_schedules = _instance.get_trainer_schedules
get_trainer_schedule_for_weekday = _instance.get_trainer_schedule_for_weekday
get_user_pt_packages = _instance.get_user_pt_packages
get_user_pt_package_detail = _instance.get_user_pt_package_detail
get_pt_bookings_for_package = _instance.get_pt_bookings_for_package
has_trainer_pt_booking_conflict = _instance.has_trainer_pt_booking_conflict
has_user_pt_booking_conflict = _instance.has_user_pt_booking_conflict
has_active_pt_package = _instance.has_active_pt_package
create_user_pt_package = _instance.create_user_pt_package
create_pt_booking = _instance.create_pt_booking
get_pt_booking_by_id = _instance.get_pt_booking_by_id
get_user_pt_package_by_id = _instance.get_user_pt_package_by_id
cancel_active_bookings_for_package = _instance.cancel_active_bookings_for_package
