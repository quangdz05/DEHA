...
from gym_booking_backend.application.interfaces import IBookingRepository
...
_instance = DjangoBookingRepository()
get_booking_by_id = _instance.get_booking_by_id
get_next_waitlisted_booking = _instance.get_next_waitlisted_booking
get_user_bookings = _instance.get_user_bookings
has_duplicate_booking = _instance.has_duplicate_booking
has_overlapping_booking = _instance.has_overlapping_booking
has_user_overlapping_time = _instance.has_user_overlapping_time
has_trainer_overlapping_time = _instance.has_trainer_overlapping_time
create_booking = _instance.create_booking
count_user_bookings_in_week = _instance.count_user_bookings_in_week
get_user_trainer_bookings = _instance.get_user_trainer_bookings
get_trainer_personal_bookings = _instance.get_trainer_personal_bookings
get_trainer_booking_by_id = _instance.get_trainer_booking_by_id
has_completed_booking_for_trainer = _instance.has_completed_booking_for_trainer
has_completed_booking_for_class = _instance.has_completed_booking_for_class
create_trainer_booking = _instance.create_trainer_booking
get_user_trainer_monthly_bookings = _instance.get_user_trainer_monthly_bookings
get_trainer_monthly_bookings = _instance.get_trainer_monthly_bookings
get_all_trainer_monthly_bookings = _instance.get_all_trainer_monthly_bookings
get_trainer_monthly_booking_by_id = _instance.get_trainer_monthly_booking_by_id
has_overlapping_monthly_booking = _instance.has_overlapping_monthly_booking
create_trainer_monthly_booking = _instance.create_trainer_monthly_booking
